        ...
        with patch('utils.chat_panel.get_session_profile') as mock_profile:
            ...
            for i, prompt in enumerate(prompts):
                ...
                if mock_button.return_value:  # Simulate button click
                    ...
                    session_dict[f"chat_input_test_key"] = prompt
                    session_dict[f"chat_autosend_test_key"] = True
                    break
            
            # Check that autosend mechanism would be triggered
            assert session_dict.get(f"chat_autosend_test_key") is True
            assert session_dict.get(f"chat_input_test_key") in prompts
